<div align="center">
  ...
  <h2><a href="https://github.com/uwo-fast/Slice_HEAT"> Slice HEAT </a></h2>
  <!-- Labels: -->
  <!-- First row: -->
  ...
  <!-- Second row: -->
  <br>
  <a href="https://github.com/uwo-fast/Slice_HEAT/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/uwo-fast/Slice_HEAT" alt="License">
  </a>
  <a href="https://github.com/uwo-fast/Slice_HEAT">
    <img src="https://img.shields.io/github/repo-size/uwo-fast/Slice_HEAT" alt="Repo Size">
  </a>
  <a href="https://github.com/uwo-fast/Slice_HEAT/issues">
    <img src="https://img.shields.io/github/issues/uwo-fast/Slice_HEAT" alt="Issues">
  </a>
  <a href="https://github.com/uwo-fast/Slice_HEAT/network/members">
    <img src="https://img.shields.io/github/forks/uwo-fast/Slice_HEAT?style=social" alt="Forks">
  </a>
  <a href="https://github.com/uwo-fast/Slice_HEAT/stargazers">
    <img src="https://img.shields.io/github/stars/uwo-fast/Slice_HEAT?style=social" alt="Stars">
  </a>
  <!-- Short description: -->
  <h3>Heating Element Controller Slice for BREAD.</h3>
</div>
